...
package net.sourceforge.teabee.view.third {
    ...
    public class ReflectionManager extends UIComponent {
        ...
        private var _distance:Number = 40; /* 1-100 */
        ...
        private function targetResizeHandler(event:ResizeEvent):void {
            ...
            this.height = (_target.height / 100) * this._distance;
            this.invalidateDisplayList();
        }
        
        private function targetRemovedHandler(event:Event):void {
            if(this.parent != null) { // TODO by chp: added null-check (was null when dragging item from list)
            	this.parent.removeChild(this);
            }
        }
        
        override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void {
            if (_target != null && this._bitmap.bitmapData != null) { // TODO change by chp: && this._bitmap.bitmapData != null
        ...
        private function drawReflection(target:UIComponent):void { 
            if (this.width > 0 && this.height > 1.0) { // TODO by chp: chagned height > 0.0 to height > 1.0
