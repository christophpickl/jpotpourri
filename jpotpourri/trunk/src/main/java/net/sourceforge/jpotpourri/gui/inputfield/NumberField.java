...
//    private final int maxColSize;
    ...
    public NumberField(final long initVal, final long minVal, final long maxVal) {
     ...
     */
    public NumberField(final long initValue, final long minValue, final long maxValue, final int size) {
...
//    }
    ...
    private class IntTextDocument extends PlainDocument {
		...
		public void insertString(final int offs, final String str, final AttributeSet a) throws BadLocationException {
            ...
            if(NumberField.this.numberFieldConstructorFinished == false) {
            ...
            try {
                ...
                final boolean isValidValue = (value >= NumberField.this.minValue && value <= NumberField.this.maxValue);
                if(DEBUG) {
                	System.out.println("DEBUG: is valid value " + isValidValue + " " + "(value=" + value + "; " +
                			"minVal=" + NumberField.this.minValue + "; maxVal=" + NumberField.this.maxValue + ")");
                }
