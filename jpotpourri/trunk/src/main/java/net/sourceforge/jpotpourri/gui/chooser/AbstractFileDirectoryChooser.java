...
abstract class AbstractFileDirectoryChooser extends JPanel implements ActionListener {
    ...
    public AbstractFileDirectoryChooser(final String dialogTitle, final ButtonPosition position) {
    ...
    public AbstractFileDirectoryChooser(final String dialogTitle, final File defaultPath,
    		final ButtonPosition position, final String buttonLabel) {
    ...
    public final void actionPerformed(final ActionEvent event) {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            for (final IFileDirectoryChooserListener listener : this.listeners) {
    ...
    public final void addChooserListener(final IFileDirectoryChooserListener listener) {
        this.listeners.add(listener);
    }
    public final void removeDirectoryChooserListener(final IFileDirectoryChooserListener listener) {
