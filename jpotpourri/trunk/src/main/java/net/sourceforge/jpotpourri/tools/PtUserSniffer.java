...
public final class PtUserSniffer {
    ...
    public static boolean isOperatingSystem(final PtOperatingSystem isOs) {
        return PtUserSniffer.os.equals(isOs);
    }

    public static boolean isWindows() {
        return PtUserSniffer.os.equals(PtOperatingSystem.WIN);
    }

    public static boolean isMacOSX() {
        return PtUserSniffer.os.equals(PtOperatingSystem.MAC);
    }

    public static boolean isLinux() {
        return PtUserSniffer.os.equals(PtOperatingSystem.LINUX);
    }

    public static boolean isUnix() {
        return PtUserSniffer.os.equals(PtOperatingSystem.UNIX);
    }

    public static boolean isOS2() {
        return PtUserSniffer.os.equals(PtOperatingSystem.OS2);
    }

    public static boolean isUnkown() {
        return PtUserSniffer.os.equals(PtOperatingSystem.UNKOWN);
    }
