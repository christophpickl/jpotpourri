...
public class DateField extends JTextField {
    ...
    public DateField(final Date date, final SimpleDateFormat format, final int columnSize) {
    ...
    public DateField(final Date date, final int columnSize) {
    ...
    private class DateTextDocument extends PlainDocument {
		...
		public void insertString(final int offs, final String str, final AttributeSet a) throws BadLocationException {
            ...
            if(DateField.this.numberFieldConstructorFinished == false) {
            ...
            final boolean isValidValue = DateField.isValid(newDateText); 
